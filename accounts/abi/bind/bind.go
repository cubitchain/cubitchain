...
//
// Detailed usage document and tutorial available on the cubitchain Wiki page:
// https://github.com/cubitchain/cubitchain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
